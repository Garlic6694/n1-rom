...
# Add crontab
echo '*/1 * * * * pidof mwan3-watchdog || /usr/bin/mwan3-watchdog' >> /etc/crontabs/root
...
svn co https://github.com/cocokfeng/luci-theme-argon/trunk feeds/luci/themes/luci-theme-argon
...
cp -f package/lean/luci-argon/htdocs/luci-static/argon/img/bg1.jpg feeds/luci/themes/luci-theme-argon/htdocs/luci-static/argon/img/bg1.jpg
